...
export const BIRKAT_HAMAZONE: BirkatVersion[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      { hebrew: "רַבּוֹתַי נְבָרֵךְ:", transliteration: "Rabotaï névarèkh.", section: "zimoun", role: "leader" },
      { hebrew: "יְהִי שֵׁם יְהֹוָה מְבֹרָךְ מֵעַתָּה וְעַד־עוֹלָם:", transliteration: "Yéhi chèm Ado-naï mévorakh méata véad olam.", section: "zimoun", role: "response" },
      { hebrew: "בִּרְשׁוּת רַבּוֹתַי, נְבָרֵךְ (אֱלֹהֵינוּ) שֶׁאָכַלְנוּ מִשֶּׁלּוֹ:", transliteration: "Birchout rabotaï, névarèkh (Élo-hénou) chéakhalnou michélo.", section: "zimoun", role: "leader" },
      { hebrew: "בָּרוּךְ (אֱלֹהֵינוּ) שֶׁאָכַלְנוּ מִשֶּׁלּוֹ וּבְטוּבוֹ חָיִינוּ:", transliteration: "Baroukh (Élo-hénou) chéakhalnou michélo ouvétouvo 'hayinou.", section: "zimoun", role: "response" },
      // ── 1re brakha : HaZane ──
