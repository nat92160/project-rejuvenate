...
export const BIRKAT_INSERTS: BirkatInsert[] = [
  ...
  },
  {
    ...
    transliteration: "Véal hanissim véal hapourkan véal haguévourot véal hatéchouot véal hamil'hamot chaassita laavotéinou bayamim hahèm bazémane hazé. Bimé Matityahou bèn Yo'hanane kohèn gadol, 'Hachmonaï ouvanav, kchéamedah malkhout Yavan harechaa al amékha Israël léhachki'ham Toratékha ouléhaaviram mé'houkéi rétsonékha...",
  ...
  },
  {
    ...
    transliteration: "Véal hanissim véal hapourkan... Bimé Mordékhaï véEstèr béChouchane habira, kchéamad aléhèm Hamane haracha, bikèch léhachmid laharog ouléabed èt kol hayéhoudim minaar véad zakèn taf vénachim béyom é'had...",
    instruction: "S'ajoute dans la 2e brakha (Nodé Lékha), après « békhol yom ouvékhol èt ouvékhol chaah ».",
    insertBeforeMarker: "וְעַל הַכֹּל",
  },
];
...
export const BIRKAT_HAMAZONE: BirkatVersion[] = [
  {
    ...
    paragraphs: [
      ...
      { hebrew: "בִּרְשׁוּת מָרָנָן וְרַבָּנָן וְרַבּוֹתַי נְבָרֵךְ (אֱלֺהֵֽינוּ) שֶׁאָכַֽלְנוּ מִשֶּׁלּוֹ:", transliteration: "Birchout maranan vérabanan vérabotaï, névarèkh (Élo-hénou) chéakhalnou michélo." },
      { hebrew: "בָּרוּךְ (אֱלֺהֵֽינוּ) שֶֽׁאָכַֽלְנוּ מִשֶּׁלּוֹ וּבְטוּבוֹ חָיִֽינוּ:", transliteration: "Baroukh (Élo-hénou) chéakhalnou michélo ouvétouvo 'hayinou." },
      // ── 1re brakha : HaZane ──
      ...
      // ── HaRa'hamane ──
      { hebrew: "הָרַחֲמָן הוּא יִמְלוֹךְ עָלֵֽינוּ לְעוֹלָם וָעֶד:", transliteration: "Hara'hamane, hou yimlokh alénou léolam vaèd." },
      { hebrew: "הָרַחֲמָן הוּא יִתְבָּרַךְ בַּשָּׁמַֽיִם וּבָאָֽרֶץ:", transliteration: "Hara'hamane, hou yitbarakh bachamaïm ouvaartèts." },
      { hebrew: "הָרַחֲמָן הוּא יִשְׁתַּבַּח לְדוֹר דּוֹרִים, וְיִתְפָּאַר בָּֽנוּ לָעַד וּלְנֵֽצַח נְצָחִים, וְיִתְהַדַּר בָּֽנוּ לָעַד וּלְעוֹלְ֒מֵי עוֹלָמִים:", transliteration: "Hara'hamane, hou yichtaba'h lédor dorim, véyitpaèr banou laad oulnétsa'h nétsa'him, véyithadar banou laad ouléolmé olamim." },
      { hebrew: "הָרַחֲמָן הוּא יְפַרְנְ֒סֵֽנוּ בְּכָבוֹד:", transliteration: "Hara'hamane, hou yéfarnéssènou békavod." },
      { hebrew: "הָרַחֲמָן הוּא יִשְׁבּוֹר עֻלֵּֽנוּ מֵעַל צַוָּארֵֽנוּ וְהוּא יוֹלִיכֵֽנוּ קוֹמְ֒מִיּוּת לְאַרְצֵֽנוּ:", transliteration: "Hara'hamane, hou yichbor oulénou méal tsavarénou, véhou yolikhénou komémiout léartsènou." },
      { hebrew: "הָרַחֲמָן הוּא יִשְׁלַח לָֽנוּ בְּרָכָה מְרֻבָּה בַּבַּֽיִת הַזֶּה וְעַל־שֻׁלְחָן זֶה שֶׁאָכַֽלְנוּ עָלָיו:", transliteration: "Hara'hamane, hou yichla'h lanou bérakha mérouba babaït hazé, véal choul'hane zé chéakhalnou alav." },
      { hebrew: "הָרַחֲמָן הוּא יִשְׁלַח לָֽנוּ אֶת־אֵלִיָּֽהוּ הַנָּבִיא זָכוּר לַטּוֹב, וִיבַשֶּׂר־לָֽנוּ בְּשׂוֹרוֹת טוֹבוֹת יְשׁוּעוֹת וְנֶחָמוֹת:", transliteration: "Hara'hamane, hou yichla'h lanou èt Éliyahou hanavi zakhor latov, vivassèr lanou béssorot tovot yéchouot véné'hamot." },
      { hebrew: "הָרַחֲמָן הוּא יְבָרֵךְ אֶת־(אָבִי מוֹרִי) בַּֽעַל הַבַּֽיִת הַזֶּה, וְאֶת־(אִמִּי מוֹרָתִי) בַּעֲלַת הַבַּֽיִת הַזֶּה, אוֹתָם וְאֶת־בֵּיתָם וְאֶת־זַרְעָם וְאֶת־כָּל־אֲשֶׁר לָהֶם:", transliteration: "Hara'hamane, hou yévarèkh èt (avi mori) baal habaït hazé, véèt (imi morati) baalat habaït hazé, otam véèt bétam véèt zaram véèt kol achèr lahèm." },
