              ...
              >
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="font-display text-[13px] font-bold leading-tight" style={{ color: pmText }}>{sec.title}</p>
                    <p className="text-[11px] mt-0.5 leading-tight" style={{ fontFamily: "'Frank Ruhl Libre', serif", color: pmMuted }}>{sec.heTitle}</p>
                  </div>
