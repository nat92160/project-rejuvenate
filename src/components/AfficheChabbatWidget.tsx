...
const AfficheChabbatWidget = () => {
  ...
  const posterContent: PosterContentBlock = {
    ...
    details: [
      ...
      ...(moussaf || notes.moussaf ? [{ section: "CHABBAT MATIN", label: "Moussaf", value: moussaf || notes.moussaf || "", sub: moussaf && notes.moussaf ? notes.moussaf : undefined }] : []),
      ...(minhaSat || notes.minhaSat ? [{ section: "CHABBAT APRÈS-MIDI", label: "Minha", value: minhaSat || notes.minhaSat || "", sub: minhaSat && notes.minhaSat ? notes.minhaSat : undefined }] : []),
      ...
      ...(arvitMotse || notes.arvitMotse ? [{ section: "MOTSÉ CHABBAT", label: "Arvit", value: arvitMotse || notes.arvitMotse || "", sub: arvitMotse && notes.arvitMotse ? notes.arvitMotse : undefined }] : []),
